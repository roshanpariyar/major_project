...
<?php
if(!defined("LANG_VALUE_25")){
      define("LANG_VALUE_25",'Order History');

}
if(!defined("LANG_VALUE_27")){
     define("LANG_VALUE_27",'	
     Payment Date and Time');	}

if(!defined("LANG_VALUE_28")){
         define("LANG_VALUE_28",'	
Transaction ID');}
 

        if(!defined("LANG_VALUE_29")){
        define("LANG_VALUE_29",'	
        Paid Amount');}	
        if(!defined("LANG_VALUE_30")){
        define("LANG_VALUE_30",'Payment Status');}	
            
            if(!defined("LANG_VALUE_31")){
     define("LANG_VALUE_31",' 	
     Payment Method');	
    }	
       
            if(!defined("LANG_VALUE_32")){
        define("LANG_VALUE_32", 'Payment ID');	}	

        
if(!defined("LANG_VALUE_48")){
    define("LANG_VALUE_48",'Product Details');}
