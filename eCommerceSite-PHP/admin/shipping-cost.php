...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        $statement = $pdo->prepare("INSERT INTO tbl_shipping_cost (state_id,amount) VALUES (?,?)");
        $statement->execute(array($_POST['state_id'],$_POST['amount']));
                            ...
                            <div class="col-sm-4">
                                <select name="state_id" class="form-control select2">
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        $statement = $pdo->prepare("SELECT * FROM tbl_shipping_cost WHERE state_id=?");
                                        $statement->execute(array($row['state_id']));
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: If a state does not exist in the above list, the following "Rest of the World" shipping cost will be applied upon that.</h4>
