                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <option value="<?php echo $row['state_id']; ?>" <?php if($row['state_id'] == $_SESSION['customer']['cust_country']) {echo 'selected';} ?>><?php echo $row['state_name']; ?></option>
                                    <?php
                                }
                                ?>
                                </select>                                    
