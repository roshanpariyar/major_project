                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cust_b_country" class="form-control">
                                        ...
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['state_id']; ?>" <?php if($row['state_id'] == $_SESSION['customer']['cust_b_country']) {echo 'selected';} ?>><?php echo $row['state_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cust_s_country" class="form-control">
                                        ...
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['state_id']; ?>" <?php if($row['state_id'] == $_SESSION['customer']['cust_s_country']) {echo 'selected';} ?>><?php echo $row['state_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
