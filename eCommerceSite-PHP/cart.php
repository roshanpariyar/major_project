...
define("LANG_VALUE_8",'Photo');
}
if(!defined("LANG_VALUE_47")){
define("LANG_VALUE_47",'Product Name');	
 

    }if(!defined("LANG_VALUE_55")){
        define("LANG_VALUE_55",'Quantity');
        }
        if(!defined("LANG_VALUE_158")){
          define("LANG_VALUE_158",'Color');}	

        if(!defined("LANG_VALUE_159")){
             define("LANG_VALUE_159",'Price');}	

        if(!defined("LANG_VALUE_157")){
              define("LANG_VALUE_157",'Size');}

            if(!defined("LANG_VALUE_82")){
                  define("LANG_VALUE_82",'Total');}
